...
def mutual_template(isPlain, user_id, num_of_mutual_friends):
	if isPlain:
		text = "Talk to {{user-%d}} as you have %d mutual friends in common" % (user_id, num_of_mutual_friends)
	else:
		text = "Talk to <b>{{user-%d}}</b> as you have %d mutual friends in common" % (user_id, num_of_mutual_friends)
