...
const JobList = ({ jobs }) => (
  <table id="datatables" className="table table-striped table-no-bordered table-hover dataTable dtr-inline" cellSpacing="0" width="100%" style={{'width': '100%'}} role="grid">
    <thead>
      <tr role="row">
      <th className="sorting_asc" tabIndex="0" aria-controls="datatables" rowSpan="1" colSpan="1" style={{'width': '100px'}} aria-sort="ascending">ID</th>
      <th className="sorting" tabIndex="0" aria-controls="datatables" rowSpan="1" colSpan="1" style={{'width': '200px'}} >Name</th>
      <th className="sorting" tabIndex="0" aria-controls="datatables" rowSpan="1" colSpan="1" style={{'width': '100px'}} >State</th>
